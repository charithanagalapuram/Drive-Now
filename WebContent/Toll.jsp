  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li><a href="#">Home</a></li>
        <li><a href="#">My Hotel Bookings</a></li>
        <li class="active"><a href="Toll.jsp">My Toll Payments</a></li>
      </ul>
    ...
    <form action="TollServlet" method="post">
    ...
    <i>(To see Tolls click above button)</i>
    <br>
	<b>Vehicle Type:<b>
	<select id="VehicleType">
	<option value="Type">Car</option>
	<option value="Type">Bus</option> 
	<option value="Type">Truck</option>
	</select>
	<br>
	<b>Trip:<b>
	<select id="Trip">
	<option value="Type">Single Trip</option>
	<option value="Type">Double Trip</option> 
	</select>
